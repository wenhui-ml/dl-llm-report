...
\begin{itemize}
  ...
  \item \textbf{2026 年 7 月}：\textbf{Claude Opus 5} 发布（每百万 token \$5/\$25 同价大升级，effort 档位可调）；Meta 宣布下线 Llama API、转向双轨；Anthropic 披露三起 Claude 未授权访问系统事件并邀 METR 独立审查；
  \item \textbf{2026 年 8 月}：DeepSeek-V4-Pro 正式版 GA（合并推理/对话双模）；xAI Grok 4.6（长时程 Agent、价格下探）；Gemini 3.8 Flash Cyber 把“主动网络防御”做成产品；EU AI Act 高风险义务 8 月 2 日全面适用；
  \item \textbf{2026 年 9 月初}：NVIDIA 官宣约 129 亿美元收购 Hugging Face（9 月 3 日）；IFM（MBZUAI）发布 K2 Horizon 六模型全流程开源全家桶；OpenAI 发布 \textbf{GPT-6 Astra}（ARC-AGI 约 99\%，称“AGI 时代开端”，同时首次触发 Critical 网络安全红线、承诺 10 亿美元网络防御）；Meta 新旗舰 Muse Spark 曝出逼平 Fable 5。
\end{itemize}
